    ...
    return (
      <div className="chat-container d-flex flex-column h-100 justify-content-between p-4 border rounded-3 bg-white">
        <div>
          <div className="d-flex justify-content-between align-items-center pb-3 border-bottom mb-4">
            <div className="d-flex align-items-center gap-2">
              ...
              <h5 className="mb-0 fw-bold text-dark">ContextaAI Chat bot</h5>
            </div>
          ...
          <div className="text-center mb-4">
            <h6 className="fw-semibold text-dark mb-1">Your Event Assistant</h6>
            <p className="small text-muted mb-0">Tell us a little about you so we can help you discover the right events.</p>
          </div>
          <form onSubmit={handleOnboardSubmit}>
            ...
            <div className="mb-3">
              <label htmlFor="onboard-profession" className="form-label small fw-medium text-secondary">What are you interested in?</label>
              <select
        ...
        <option value="other">Other</option>
            ...
            <div className="mb-4">
              <label htmlFor="onboard-goal" className="form-label small fw-medium text-secondary">What kind of events are you looking for?</label>
              <textarea
                id="onboard-goal"
                className="form-control"
                rows="3"
                placeholder="e.g. AI meetups, startup workshops, music events..."
                value={goalInput}
    ...
    <div className="chat-container">
      ...
      <div className="d-flex justify-content-between align-items-center px-3 py-2 border-bottom shadow-sm bg-white">
        <div className="d-flex align-items-center gap-2">
          <span className="fs-4">💬</span>
          <div>
            <h6 className="mb-0 fw-bold text-dark">ContextaAI Chat bot</h6>
